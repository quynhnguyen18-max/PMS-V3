...
12. **Chia sẻ kết quả:** CTA `Chia sẻ kết quả` luôn mở dialog xác nhận, không tự chia sẻ ngay. Bắt buộc chọn một phạm vi: `Người nhận phản hồi và các cấp quản lý của họ`, `Chỉ các cấp quản lý của người nhận`, hoặc `Người cụ thể`. Các option chỉ giữ nhãn chính, không lặp metadata mô tả. `Người cụ thể` dùng combobox người dùng chuẩn M-04 và hiện danh sách khi gõ tên/domain. Chip người đã chọn đứng trên ô tìm kiếm, dùng avatar hồng đậm, nền hồng nhạt và font 12px như picker M-04. Khối chỉ đọc tên `Thông tin người cho phản hồi`: ghi danh hiển thị “Hiển thị tên người cho phản hồi cùng nội dung.”, ẩn danh hiển thị “Chỉ hiển thị nội dung phản hồi.” Dialog không dùng CTA Hủy, đóng bằng click ngoài overlay. Status chia sẻ kết quả trong panel tổng quan hiển thị một hàng: chưa chia sẻ gồm status và CTA; đã chia sẻ gồm status và metadata. `Thông tin người cho` luôn đứng sau `Phản hồi đang chờ`. Phạm vi chia sẻ và trạng thái thu thập là hai dữ liệu độc lập.

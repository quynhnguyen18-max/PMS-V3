(function(root,factory){
  ...
  function normalize(template,currentUser={}){
    ...
    return {
      ...
      ownerDepartment:String(template&&template.ownerDepartment||(ownerId===currentUser.id?currentUser.department:'')||'').trim(),
      ownerDivision:String(template&&template.ownerDivision||(ownerId===currentUser.id?currentUser.division:'')||'').trim(),
  ...
  function makeCopy(template,currentUser,id,at=''){
    ...
    return normalize({
      ...
      ownerDivision:currentUser.division||'',

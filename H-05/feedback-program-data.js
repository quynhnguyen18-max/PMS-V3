(function(root,factory){
  ...
  const PROGRAMS=[
    ...
    {id:'s14',goal:'Phản hồi giữa kỳ nhóm Backend - ITC',requestSource:'hr',requestedBy:{name:'Lê Minh Thu',domain:'minhthu.le',initials:'LT'},invitationMessage:'HR mời bạn chia sẻ góc nhìn về cách phối hợp trong nhóm Backend nửa đầu năm.',status:'closed',createdAt:'02/08/2026',due:'20/08/2026',identityVisibility:'named',anon:'named',participants:1,participantIds:['long.pham'],reviewers:2,reviewerMappings:[{participantId:'long.pham',reviewerIds:['anh.nguyen','tu.nguyen']}],total:2,done:1,report:'none',resultSharing:{mode:'not_shared'}},
